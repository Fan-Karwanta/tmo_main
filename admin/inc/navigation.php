        ...
        <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
          ...
          <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>admin/?page=accidents" class="nav-link nav-accidents">
              ...
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>admin/?page=accident_map" class="nav-link nav-accident_map">
                  <i class="nav-icon fas fa-map-marked-alt"></i>
                  <p>
                    Mapping of Accident Prone Areas
                  </p>
                </a>
              </li>
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>admin/?page=accident_analytics" class="nav-link nav-accident_analytics">
